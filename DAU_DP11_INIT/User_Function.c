...
/*inizializzazione del timer 5, responsabile della scrittura dati su can*/
void tmr5_init(void){
...
IPC5bits.T5IP = 0b100;     //interrupt priority 4

IFS1bits.T5IF = 0b0;       //clear interrupt
IEC1bits.T5IE = 0b1;       //enable interrupt

TMR5 = 0b0;
PR5  = 0b0110000110101000;                        //25000
...
TMR4 = 0;
PR4  = 20000;         //credo sia da sistemare questo valore, non so se è coerente con l'acquisizione a 5khz che facciamo
